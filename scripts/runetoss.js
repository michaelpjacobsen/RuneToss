...
new rune('Kenaz - "Torch"','Torches represent skill and knowledge, because it’s fire in our control that illuminates the world around us. This is a sign that you should be enaged in teaching and learning. Furthermore, you should be doing it passionately. Enlightenment is maintaining a state of inspiration.','torch'),
